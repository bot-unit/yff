...
class YahooFinanceFetcher(metaclass=SingletonMeta):
    ...
    async def create_session(self):
        self._session = aiohttp.ClientSession(raise_for_status=True, timeout=self._timeout, headers={'User-Agent': self.user_agent})
    ...
    def _build_url(self, path: str) -> str:
        return random.choice(self.api_urls) + path
